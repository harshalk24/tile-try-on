      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {personas.map((persona, index) => (
            <div
              key={index}
              className="bg-[#F6F7F8] rounded-lg p-8 hover:bg-[#E6E6E6] transition-colors flex flex-col"
            >
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-[#FF6B35]/10 mb-6">
                <persona.icon className="h-8 w-8 text-[#FF6B35]" />
              </div>
              ...
              {persona.callout && (
                <div className="mb-4 px-3 py-1.5 bg-[#FF6B35]/10 text-[#FF6B35] text-sm font-medium rounded-full inline-block">
                  {persona.callout}
                </div>
              )}
              ...
              <ul className="space-y-3 mb-6 flex-grow">
                {persona.bullets.map((bullet, i) => (
                  <li key={i} className="flex items-start text-[#222]/70">
